...
export default function CategoryPopup({ productImage }) {
    ...
    const handleSubmit = async (e) => {
        ...
        const data = {
            ...
            product: productImage?.category?.name || "NA",
                    ...
                    >
                        ...
                        <div className="grid md:grid-cols-2 gap-8 relative">
                            ...
                            <div className="md:flex flex-col hidden">
                                <div className="border border-gray-200 rounded-lg w-auto h-100">
                                    <img
                                        src={productImage?.category?.imageUrl}
                                        alt={"Image"}
